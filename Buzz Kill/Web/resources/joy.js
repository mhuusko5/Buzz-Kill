...
(function(J) {
  ...
  Engine.prototype.onEnterFrame = function () {
    if (!J.currentEngine.paused) {
      ...
      //TODO: This should save some CPU
...
(function(J) {
  ...
  window.onEnterFrame = (function(){
     //TODO: Again, reduce CPU?
      /**/
    return window.requestAnimationFrame ||
        window.webkitRequestAnimationFrame ||
        window.mozRequestAnimationFrame    ||
        window.oRequestAnimationFrame      ||
        window.msRequestAnimationFrame     || function( callback ) { window.setTimeout(callback, 1000 / 30); }; // TODO: use FPS rate from render module
  })();
})(Joy);
...
(function(J) {
  var DisplayObjectContainer = J.DisplayObject.extend({
    ...
    renderChildren: function () {
      for (var i = 0, length = this.children.length; i<length; ++i) {
        if (!this.children[i] || !this.children[i].visible) { continue; }
        this.ctx.save();
...
(function(J) {
  ...
  var Sprite = J.DisplayObjectContainer.extend({
    ...
    render: function() {
      if (!this || !this.visible || !this.image) { return; }
      try {
...
(function(J) {
  ...
  var SpriteSheet = J.Sprite.extend({
    init: function (options) {
       ...
       * @type {Number}
       */
      this.framesPerSecond = 6;//options.framesPerSecond || options.fps || 24;
    ...
    render: function() {
      if (!this || !this.visible || !this.ctx.drawImage) { return; }
